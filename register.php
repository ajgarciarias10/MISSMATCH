...
//Vemos si el formulario ha sido enviado. Si lo hemos enviado el elemento 'submit' de $_POST existe
 if (!func::checkLogin($con)){
        ...
        {  if (isset($_POST['username']) && isset($_POST['password'])){
                ...
                $sql="INSERT INTO users (user_id , user_username	, user_password, user_status,user_firstname,user_lastname,
                      user_gender,user_birthdate,user_city,user_picture,user_state) 
                      VALUES (null, :user_username, :user_password, 0,:user_firstname,
                              :user_lastname,:user_gender,:user_birthdate,:user_city,:user_picture,:user_state)";
           ...
           <form class="register" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" method="post">
              ...
              <div class="row mb-3">
               ...
               <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="user_name" class="form-control" id="user_name" name="user_name" placeholder="Type First Name">
                </div>
              </div>
                <div class="row mb-3">
                <label for="user_surname" class="col-sm-2 col-form-label">Surname</label>
                <div class="col-sm-10">
                  <input type="user_surname" class="form-control" id="user_surname" name="user_surname" placeholder="Type Surname">
                </div>
              </div>
              <div class="row mb-3">
                <label for="birthdate" class="col-sm-2 col-form-label">Birthdate</label>
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="birthdate" name="user_birthdate">
                </div>
              </div>
               <div class="row mb-3">
                <label for="city" class="col-sm-2 col-form-label">City</label>
                <div class="col-sm-10">
                  <input type="city" class="form-control" id="city" name="user_city">
                </div>
              </div>
                <div class="col-sm-3">
